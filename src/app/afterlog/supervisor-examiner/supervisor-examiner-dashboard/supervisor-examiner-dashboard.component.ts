...
@Component({
  selector: 'app-supervisor-examiner-dashboard',
  templateUrl: './supervisor-examiner-dashboard.component.html',
  styleUrl: './supervisor-examiner-dashboard.component.css'
})
export class SupervisorExaminerDashboardComponent {
